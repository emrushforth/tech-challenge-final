...
<body>
    <style>
        ...
        font-style: normal;
        font-weight: 400;
        src: url('./fonts/space-grotesk-v12-latin-regular.eot'); /* IE9 Compat Modes */
        src: local(''),
            url('./fonts/space-grotesk-v12-latin-regular.eot?#iefix') format('embedded-opentype'), /* IE6-IE8 */
            url('./fonts/space-grotesk-v12-latin-regular.woff2') format('woff2'), /* Super Modern Browsers */
            url('./fonts/space-grotesk-v12-latin-regular.woff') format('woff'), /* Modern Browsers */
            url('./fonts/space-grotesk-v12-latin-regular.ttf') format('truetype'), /* Safari, Android, iOS */
            url('./fonts/space-grotesk-v12-latin-regular.svg#SpaceGrotesk') format('svg'); /* Legacy iOS */
        }
        ...
        font-style: normal;
        font-weight: 700;
        src: url('./fonts/space-grotesk-v12-latin-700.eot'); /* IE9 Compat Modes */
        src: local(''),
            url('./fonts/space-grotesk-v12-latin-700.eot?#iefix') format('embedded-opentype'), /* IE6-IE8 */
            url('./fonts/space-grotesk-v12-latin-700.woff2') format('woff2'), /* Super Modern Browsers */
            url('./fonts/space-grotesk-v12-latin-700.woff') format('woff'), /* Modern Browsers */
            url('./fonts/space-grotesk-v12-latin-700.ttf') format('truetype'), /* Safari, Android, iOS */
            url('./fonts/space-grotesk-v12-latin-700.svg#SpaceGrotesk') format('svg'); /* Legacy iOS */
        }
        ...
        #orb1{
            ...
            background: radial-gradient(circle, rgba(255,0,254,0.25) 0%, rgba(255,0,0,0) 70%);
            left: 0%;
            top: 10%;
            transition: all 1s;
        }
        #orb2{
            ...
            background: radial-gradient(circle, rgba(0,151,255,0.25) 0%, rgba(255,255,255,0) 60%);
            left: 25%;
            top: 10%;
            transition: all 1.4s;
        }
        #orb3{
            ...
            background: radial-gradient(circle, rgba(106,0,255,0.25) 0%, rgba(255,255,255,0) 40%);
            left: 55%;
            top: 10%;
        ...
        #orb4{
            ...
            background: radial-gradient(circle, rgba(0,66,255,0.25) 0%, rgba(255,255,255,0) 60%);
            left: 25%;
            top: 10%;
            transition: all 1.9s;
        }
    ...
    <div id="detail" style="display:none">
        ...
        <section>
            <div class="container" id="productBanner">
                ...
                <img id="productImage" src="https://rzroffice.blob.core.windows.net/web/sampleimage.png" alt="">
                <div class="row">
                    <div class="text-center">
            ...
            <div class="container">
                <div class="row">
                    <div class="w-100 d-flex d-lg-none flex-row justify-content-start align-items-center mb-2" id="productBadgesMobile"></div>  
                    <div class="col-lg-7">
                        <h3 id="productTitle">
                            Loading
                        </h3>
                        <h5 id="productSubtitle">
                            Loading
                        </h5>
                        <p id="productBody" class="text-grey-medium">
                            Loading
                        </p>
                    </div>
                    <div class="col-lg-5">
                        ...
                        <p id="productDescription" class="text-grey-medium">Loading</p>
...
document.addEventListener('DOMContentLoaded',function(){
    //Initial load of latest products
    const page_products = document.getElementById('products');
    const page_detail = document.getElementById('detail');
    ...
    $('#results').masonry()
    orbDown()
    var url = "https://62b9b32c41bf319d228329df.mockapi.io/Product";
    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState === 4) {
            ...
            for(var i = 0; i < obj.items.length; i++){
                results.innerHTML += '<div class="col-lg-4 my-3 prodWidthCap"><img src="'+obj.items[i].image+'" alt="" class="w-100"><h2>'+obj.items[i].name+'</h2><h3>&pound;'+obj.items[i].price.replace(".00","")+'</h3><p>'+obj.items[i].shortDescription+'</p><br><a href="#" class="button button-purple w-100" onclick="getProduct('+obj.items[i].id+')">View Product</a></div>'
            }
        }
    };
    xhr.send();
...
//Get individual product from link on listing page
function getProduct(x){
    ...
    orbUp()
    var url = "https://62b9b32c41bf319d228329df.mockapi.io/Product/"+x;
    var xhr = new XMLHttpRequest();
    xhr.open("GET", url);
    xhr.setRequestHeader("Accept", "application/json");
    xhr.onreadystatechange = function () {
        if (xhr.readyState === 4) {
            ...
            const productBadgesMobile = document.getElementById('productBadgesMobile')
            const productTitle = document.getElementById('productTitle')
            productName.innerHTML = obj.name
            productImage.innerHTML = obj.image
            productTitle.innerHTML = obj.pageTitle
            productSubtitle.innerHTML = obj.pageSubtitle
            productBody.innerHTML = obj.pageBody
            productDescription.innerHTML = obj.description
            productPrice.innerHTML = "&pound"+obj.price.replace(".00","")
            mobilePrice.innerHTML = "&pound"+obj.price.replace(".00","")
            document.title = obj.pageTitle
            productBadges.innerHTML = ""
            productBadgesMobile.innerHTML = ""
            for(var i = 0; i < obj.tags.length; i++){
                productBadges.innerHTML += "<div class='badge me-3'>"+obj.tags[i]+"</div>"
                productBadgesMobile.innerHTML += "<div class='badge me-3'>"+obj.tags[i]+"</div>"
            }
        }
    };
    xhr.send();
